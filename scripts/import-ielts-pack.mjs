...
// Path to exported test packs — set via IELTS_PACKS_DIR env var or configure below
const IELTS_PACKS_DIR = process.env.IELTS_PACKS_DIR || path.join(os.homedir(), 'ielts-data', 'exported-test-packs');
