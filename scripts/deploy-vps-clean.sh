...
SSH_PORT="22"
SSH_IDENTITY=""
REMOTE_DIR="/opt/quizup/beneficial-knowledge"
...
Optional:
  ...
  --remote-dir, -r        Remote app directory (default: /opt/quizup/beneficial-knowledge)
...
Example:
  SSHPASS='your_password' bash scripts/deploy-vps-clean.sh \
    --host 46.8.176.30 \
    --user quizup \
    --remote-dir /opt/quizup/beneficial-knowledge
EOF
}
